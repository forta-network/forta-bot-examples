...
describe("flash loan agent", () => {
  ...
  const createTxEvent = ({ addresses, logs, blockNumber }: any) =>
    createTransactionEvent({
      transaction: {} as any,
      logs,
  ...
  describe("handleTransaction", () => {
    ...
    it("returns a finding if a flash loan attack is detected", async () => {
      ...
      const currentBalance = "500000000000000000000";
      const previousBalance = "200000000000000000000";
      const balanceDiff = "300000000000000000000";
